                        ...
                        <form method="POST" action="{{ route('update.property') }}" id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Go here to ged Latitude from address</a>
                                    </div>
                                </div><!-- Col -->
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Go here to ged Longitude from address</a>
                                    </div>
                                </div><!-- Col -->
                            </div><!-- Row -->
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_descp" class="form-control" rows="3">
                                ...
                                <div class="row mb-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img src="{{ asset($property->property_thumbnail) }}" style="width: 150px; height: 100px;">
                                        </div>
                                </div><!-- Col -->

                                <button type="submit" class="btn btn-primary">Update Thumbnail Image</button>
